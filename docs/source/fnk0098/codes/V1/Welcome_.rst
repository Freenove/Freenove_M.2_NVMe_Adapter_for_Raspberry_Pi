...
If you receive the board as shown in Figure 1, please follow the “Tutorial_V1.0.pdf”(this tutorial) to proceed.

.. image:: ../_static/imgs/Welcome/Welcome02.png
    :align: center

If it is the one like Figure 2, please follow the “Tutorial_V2.0.pdf” under the same folder to operate.
...
All the files, materials and instructional guides provided are released under `Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License <https://creativecommons.org/licenses/by-nc-sa/3.0/>`__. A copy of this license can be found in the folder containing the Tutorial and software files associated with this product.
