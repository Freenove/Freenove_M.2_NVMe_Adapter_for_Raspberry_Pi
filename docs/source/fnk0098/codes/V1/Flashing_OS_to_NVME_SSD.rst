...
+---------------------------------------+----------------------------------------------------------------------------------------------+
| M2.5x3 Screws x5                      | Cable :red:`(You may receive either of the following cables. Both share the same function.)` |
|                                       |                                                                                              |
| |Chapter02_06|                        | |Chapter02_07|                                                                               |
+---------------------------------------+----------------------------------------------------------------------------------------------+
...
.. |Chapter02_04| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_04.png
.. |Chapter02_05| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_05.png
.. |Chapter02_06| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_06.png
.. |Chapter02_07| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_07.png

Assembly and Wiring
==================================

+-------------------------------------------------------------------------------------------------------------+
| 1. Connect the FPC cable to the FPC socket.                                                                 |
|                                                                                                             |
| Please note that the metal contacts of the ribbon cable should face downward, as shown in the figure below. |
|                                                                                                             |
| |Chapter02_08|                                                                                              |
+-------------------------------------------------------------------------------------------------------------+
...
| |Chapter02_10|                                                                                              |
+-------------------------------------------------------------------------------------------------------------+
| 4. Connect the other end of the cable to Raspberry Pi and fix the adapter to RPi with four M2.5 screws.     |
|                                                                                                             |
| |Chapter02_11|                                                                                              |
+-------------------------------------------------------------------------------------------------------------+

.. |Chapter02_08| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_08.png
.. |Chapter02_09| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_09.png
.. |Chapter02_10| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_10.png
.. |Chapter02_11| image:: ../_static/imgs/Flashing_OS_to_NVME_SSD/Chapter02_11.png
...
:ref:`(Note: Not all SSDs are supported by Pi5.) <fnk0098/codes/v1/caution__incompatible_ssds:caution: incompatible ssds>`
...
If you have confirmed that SSD is with Phison controller in :ref:`step 2 <fnk0098/codes/v1/flashing_os_to_nvme_ssd:2.2.2 enable pcie3.0 (on os written into sd card)>`, then you also need to enable PCIE3.0 on the system written into SSD.
