# Freenove_M.2_NVMe_Adapter_for_Raspberry_Pi
> A solid-state drive adapter using NVME protocol with M.2 interface, suitable for Raspberry Pi 5

<img src='imgs/freenove_m.2_adapter.jpg' width='50%'/>
...
* **Method 2 : Use command in console**
    ...
    `git clone https://github.com/Freenove/Freenove_M.2_NVMe_Adapter_for_Raspberry_Pi.git`
